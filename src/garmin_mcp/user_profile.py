...
def register_tools(app):
    ...
    async def get_full_name() -> str:
        ...
        try:
            ...
            return json.dumps({"full_name": full_name}) if full_name else "No full name found."
    ...
    async def get_unit_system() -> str:
        ...
        try:
            ...
            return json.dumps({"unit_system": unit_system}) if unit_system else "No unit system found."
        except Exception as e:
